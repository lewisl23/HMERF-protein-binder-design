...
level = c("Mutant+D1315_173", "Mutant+D1315_37","Mutant+D1295_60",
          "Mutant+D1295_198", "Mutant+D1063_37", "Mutant+D1915_0")

#Set PDF size
CairoPDF("Stat_analysis_mut", width = 7, height = 7)
...
rmsd_violin_table <- data.frame(group = rep(c("Mutant+D1315_173", "Mutant+D1315_37","Mutant+D1295_60",
                                              "Mutant+D1295_198", "Mutant+D1063_37", "Mutant+D1915_0"), each = 99000),
                                rmsd = c(rmsd_table$`Mutant+D1315_173`, rmsd_table$`Mutant+D1315_37`, rmsd_table$`Mutant+D1295_60`,
                                         rmsd_table$`Mutant+D1295_198`,rmsd_table$`Mutant+D1063_37`, rmsd_table$`Mutant+D1915_0`))
...
angle_stat$subject <- factor(angle_stat$subject, 
                             levels = c("Mutant+D1315_173", "Mutant+D1315_37","Mutant+D1295_60",
                                        "Mutant+D1295_198", "Mutant+D1063_37", "Mutant+D1915_0"))
...
bending_violin_table <- data.frame(group = rep(c("Mutant+D1315_173", "Mutant+D1315_37","Mutant+D1295_60",
                                                 "Mutant+D1295_198", "Mutant+D1063_37", "Mutant+D1915_0"), each = 99000),
                                   angle = c(angle_table$`Mutant+D1315_173`, angle_table$`Mutant+D1315_37`, angle_table$`Mutant+D1295_60`,
                                             angle_table$`Mutant+D1295_198`,angle_table$`Mutant+D1063_37`, angle_table$`Mutant+D1915_0`))
...
percentage_angle_table <- data.frame(runname = level,
                                     percentage = c(percentage_angle$`Mutant+D1315_173`, percentage_angle$`Mutant+D1315_37`,
                                                    percentage_angle$`Mutant+D1295_60`, percentage_angle$`Mutant+D1295_198`,
                                                    percentage_angle$`Mutant+D1063_37`, percentage_angle$`Mutant+D1915_0`))
